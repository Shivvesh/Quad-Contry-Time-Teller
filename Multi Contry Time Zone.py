...
india_time.place(relx=0.2,rely=0.40, anchor= CENTER)
...
usa_time = Label(root)
usa_time.place(relx=0.7,rely=0.40, anchor= CENTER)

australia_label = Label(root,text="Australia")
australia_label.place(relx=0.2,rely=0.47, anchor= CENTER)

australia_clock=Label(root)
australia_clock["image"]=australia_image
australia_clock.place(relx=0.2,rely=0.63, anchor= CENTER)

australia_time = Label(root)
australia_time.place(relx=0.2,rely=0.79, anchor= CENTER)

japan_label = Label(root,text="Japan")
japan_label.place(relx=0.7,rely=0.47,anchor= CENTER)

japan_clock=Label(root) 
japan_clock.place(relx=0.7,rely=0.63, anchor= CENTER)
japan_clock["image"]=japan_image

japan_time = Label(root)
japan_time.place(relx=0.7,rely=0.79, anchor= CENTER)
...
india_btn.place(relx=0.2,rely=0.43, anchor= CENTER)

usa_btn=Button(root,text="Show Time",command=obj_usa.times)

usa_btn.place(relx=0.7,rely=0.43, anchor= CENTER)

australia_btn=Button(root,text="Show Time",command=obj_australia.times)

australia_btn.place(relx=0.2,rely=0.82, anchor= CENTER)

japan_btn=Button(root,text="Show Time",command=obj_japan.times)

japan_btn.place(relx=0.7,rely=0.82, anchor= CENTER)
